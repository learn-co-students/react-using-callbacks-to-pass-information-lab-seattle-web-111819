...
// Child component
// Cannot communicate to Cell (child components cannot commmunicate with each other, only through parent component Matrix)
...
class ColorSelector extends React.Component {
  ...
  makeColorSwatches = () => (
    ["#F00", "#F80", "#FF0", "#0F0", "#00F", "#508", "#90D", "#FFF", "#000"].map((str, idx) => {
      ...
      // STEP 6
      // need to write the function inside the map to access the color values needed:
      let callback = () => this.props.setSelectedColor(str)

      // STEP 5
      // when any one of these divs is clicked the hexadecimal color value of that div becomes the selected color in Matrix.
